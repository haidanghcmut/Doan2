  ...
  Widget _buildCodeInput(){
    return Container(
        ...
        child: Center(child: VerificationCode(
          ...
          underlineColor: AppColors.primaryElement, // If this is null it will use primaryColor: Colors.red from Theme
          length: 6,
          cursorColor: AppColors.primaryElement, // If this is null it will default to the ambient
